<div class="container">
    ...
    <h1 class="display-1">Booking - Book yourself a table</h1><br/>
    <!--
    ...
    <?php
        ...
        if (isset($_POST['submit_btn'])) {
            ...
            if (empty($date) || empty($people) || empty($tableNo) || empty($time)) {
                ...
                $statement = "INSERT INTO booking (date, people, tableNo, time) VALUES('$date', '$people', '$tableNo', '$time')";
                echo $statement;
